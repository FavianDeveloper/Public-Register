...
const kadınrol = message.guild.roles.cache.find(r => r.id === '795297457491148810') //kadınrol isimini değişme
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '795297457491148810')
...
if(!args[0]) return message.channel.send('<:rejection:808390168239145011> Bir Kullanıcı Belirt.')  
...
<:confirmation:808390218818388001> ${kadınrol} Rolü Verildi.
